...
for concurrency in concurrency_levels:
    command = f"httperf --client=0/1 --server={server_address} --port=888 --uri={url_path} --num-conns={num_connections} --rate={concurrency} --timeout=1"
...
plt.savefig('nginx_concurrency_throughput.png')  # Save as PNG file